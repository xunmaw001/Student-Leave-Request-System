                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('dicCode')">字段</th>
                                    <th onclick="sort('dicName')">字段名</th>
                                    <th onclick="sort('codeIndex')">编码</th>
                                    <th onclick="sort('indexName')">编码名字</th>
                                    <th onclick="sort('superId')">父字段id</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "dictionary");
