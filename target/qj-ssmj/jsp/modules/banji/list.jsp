            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">班级表管理</li>
                        <li class="breadcrumb-item active">班级表列表</li>
                    </ol>
                </div>
            </div>
        </div>
